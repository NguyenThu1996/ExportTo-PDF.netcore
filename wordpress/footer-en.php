    ...
    <p id="pageTop"><a></a></p>
    <p id="btnContact"><a href="<?php echo home_url('/en/contact')?>"></a></p>
        ...
        <div class="footer-container">
            <div class="footer-main-menu">
                ...
                <div class="footer-right-menu">
                    ...
                    <a class="button-primary button-third" href="<?php echo home_url('/en/contact')?>">
                        <div class="button-primary__text button-primary__text-lg">
                            <div>Contact Us</div>
                            <div class="button-primary__text-sm">For the technical and product questions</div>
                        </div>
                        <i class="button-primary__icon arrow-right"></i>
                    </a>
                </div>
            ...
            <div class="footer-bottom-menu">
                ...
                wp_nav_menu(
                    array(
                        'theme_location' => 'footer-bottom-en',
                        'container'         => 'div',
                        'menu_class'           => 'footer-menu',
                        'fallback_cb'          => 'wp_page_menu',
                        'items_wrap'           => '<ul id="%1$s" class="%2$s">%3$s</ul>',
