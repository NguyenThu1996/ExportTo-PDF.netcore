...
define( 'THEME_IMAGES_PATH', THEME_ASSETS_PATH . DIRECTORY_SEPARATOR . 'images' );
...
define( 'THEME_INCLUDES_PATH', THEME_PATH . DIRECTORY_SEPARATOR . 'includes' );
define( 'THEME_WIDGETS_PATH', THEME_PATH . DIRECTORY_SEPARATOR . 'widgets' );
define( 'THEME_SHORTCODES_PATH', THEME_INCLUDES_PATH . DIRECTORY_SEPARATOR . 'shortcodes' );
...
define( 'THEME_FILES_URI', THEME_ASSETS_URI . '/files' );
define( 'THEME_CSS_URI', THEME_ASSETS_URI . '/css' );
define( 'THEME_FONTS_URI', THEME_ASSETS_URI . '/fonts' );
define( 'THEME_IMAGES_URI', THEME_ASSETS_URI . '/images' );
