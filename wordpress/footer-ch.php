    ...
    <p id="pageTop"><a></a></p>
    <p id="btnContact"><a href="<?php echo home_url('/ch/contact')?>"></a></p>
        ...
        <div class="footer-container">
            <div class="footer-main-menu">
                ...
                <div class="footer-right-menu">
                    ...
                    <a class="button-primary button-third" href="<?php echo home_url('/ch/contact')?>">
                        <div class="button-primary__text button-primary__text-lg">
                            <div>各種咨询・服務</div>
                            <div class="button-primary__text-sm">有関各種技术和产品的咨询服務</div>
                        </div>
                        <i class="button-primary__icon arrow-right"></i>
                    </a>
                </div>
            ...
            <div class="footer-bottom-menu">
                ...
                wp_nav_menu(
                    array(
                        'theme_location' => 'footer-bottom-ch',
                        'container'         => 'div',
                        'menu_class'           => 'footer-menu',
                        'fallback_cb'          => 'wp_page_menu',
                        'items_wrap'           => '<ul id="%1$s" class="%2$s">%3$s</ul>',
